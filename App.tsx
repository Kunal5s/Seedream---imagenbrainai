...
import PollinationsMarketplacePage from './pages/PollinationsMarketplacePage';
  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/pollinations-marketplace" element={<PollinationsMarketplacePage />} />
        <Route path="/purchase-success" element={<PurchaseSuccessPage />} />
        <Route path="/purchase-cancelled" element={<PurchaseCancelledPage />} />
      </Routes>
    </AnimatePresence>
  );
};
