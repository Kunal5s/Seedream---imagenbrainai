...
export const PLAN_DETAILS: Record<string, { planName: LicenseStatus['plan'], credits: number, creditsPerImage: number }> = {
    ...
    'polar_cl_dxRr7iGKWfMzpHYZlFGd5tY18ICJM30sDgGf80Y0dCj': { planName: 'Booster', credits: 5000, creditsPerImage: 30 },
    'polar_cl_lTBWXKtStKOn44M16Qpb2LdlE1YC7OaxWNDDo4RTpge': { planName: 'Premium', credits: 15000, creditsPerImage: 60 },
    'polar_cl_SrTKX1rcDoCW5jAoj4lZsmqnwNoocvi8oGZLu4WmoMa': { planName: 'Professional', credits: 30000, creditsPerImage: 90 },
};
